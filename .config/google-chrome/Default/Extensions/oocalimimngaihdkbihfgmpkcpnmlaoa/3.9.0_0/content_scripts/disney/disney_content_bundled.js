...
(() => {
    ...
    (() => {
        ...
        var DisneyChatApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class DisneyChatApi extends class {
            ...
            getReactionContainer() {
                return jQuery(DisneyChatApi.MAIN_WRAPPER_SELECTOR);
            }
            _injectChat() {
                this._chatHtml && jQuery(DisneyChatApi.MAIN_WRAPPER_SELECTOR).after(function(chatHtml, customCss = "") {
            ...
            getVideoTitle() {
                var _a;
                return DisneyChatApi_awaiter(this, void 0, void 0, (function*() {
                    const titleField = document.querySelector(".title-field");
                    if (titleField) return null !== (_a = titleField.textContent) && void 0 !== _a ? _a : void 0;
                }));
            }
            setChatVisible(visible, userInitiated = !0) {
                ...
                return DisneyChatApi_awaiter(this, void 0, void 0, (function*() {
                    ...
                    visible ? (jQuery("#chat-wrapper").show(), jQuery(DisneyChatApi.MAIN_WRAPPER_SELECTOR).addClass("with-chat"), 
        ...
        DisneyChatApi.MAIN_WRAPPER_SELECTOR = "#hudson-wrapper";
        var PlaybackState, SessionState, StreamingServiceName, VideoApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        var DisneyVideoApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class DisneyVideoApi extends class {
            ...
            constructor() {
                super(), this._uiEventsHappening = 0, console.log("Disney video");
            }
            ...
            waitVideoReady() {
                var _a;
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    if (!this._video) try {
                        yield delayUntil((() => {
                            const video = document.querySelector("video");
                            return video instanceof Element && video.readyState > 0;
                        }), 8e3)(), this._video = null !== (_a = document.querySelector("video")) && void 0 !== _a ? _a : void 0;
                    } catch (error) {
            ...
            _getEpisodeData() {
                var _a, _b, _c;
                const episodeSubData = null === (_a = document.querySelector(".subtitle-field")) || void 0 === _a ? void 0 : _a.textContent;
                let episodeData = {};
                if (episodeSubData) {
                    const metadata = episodeSubData.split(/(?<=^\S+)\s/), match_season = null !== (_b = metadata[0].match(/S(\d*):/)) && void 0 !== _b ? _b : [ "" ], match_episode = null !== (_c = metadata[0].match(/E(\d*)/)) && void 0 !== _c ? _c : [ "" ];
                    episodeData = {
            ...
            waitVideoApiReadyAsync() {
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this._video || (yield this.waitVideoReady());
                }));
            }
            ...
            getVideoDataAsync() {
                return new Promise(((resolve, reject) => {
                    var _a, _b;
                    const videoDuration = this._getDuration(), videoId = null !== (_a = this._getVideoId()) && void 0 !== _a ? _a : "", videoTitle = null !== (_b = this._getVideoTitle()) && void 0 !== _b ? _b : "", screen = this.getScreenSize(), videoType = this._getVideoType(), episodeData = this._getEpisodeData(), content = this.getVideoContent(videoId, videoTitle, window.location.href, videoType, episodeData);
                    void 0 !== videoDuration && void 0 !== videoId && void 0 !== videoTitle ? resolve({
                        ...
                        screen,
                        content,
                        videoState: this._getPlaybackState()
                    }) : reject();
                }));
            }
            jumpToNextEpisode(nextEpisodeMessageData) {
                ...
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    ...
                    (null !== (_a = window.location.href.match(/^.*\/([0-9a-zA-Z-]+)\??.*/)) && void 0 !== _a ? _a : [ void 0, void 0 ])[1] != nextEpisodeMessageData.videoId && window.postMessage({
                        type: "NEXT_EPISODE",
            ...
            pause() {
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this._uiEventsHappening += 1;
                    try {
                        jQuery(".btm-media-player").trigger("click"), yield delay(100)(), jQuery(".pause-icon").length > 0 && jQuery(".pause-icon").trigger("click"), 
                        yield delayUntil((() => this._getPlaybackState() === PlaybackState.PAUSED), 1e3)();
                    } catch (error) {
                        if (this._getPlaybackState() !== PlaybackState.PAUSED) throw this.logError("video was unable to pause correctly", error), 
                        error;
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
            ...
            play() {
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this._uiEventsHappening += 1;
                    try {
                        jQuery(".btm-media-player").trigger("click"), yield delay(100)(), jQuery(".play-icon").length > 0 && jQuery(".play-icon").trigger("click"), 
                        yield delayUntil((() => this._getPlaybackState() === PlaybackState.PLAYING), 1e3)();
                    } catch (error) {
                        if (this._getPlaybackState() !== PlaybackState.PLAYING) throw this.logError("video was unable to play correctly", error), 
                        error;
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
            ...
            setCurrentTime(time) {
                ...
                return DisneyVideoApi_awaiter(this, void 0, void 0, (function*() {
                    ...
                    try {
                        this._showUIAsync(), yield delay(140)();
                        const video = this.getVideoElement(), seekbar = this._getSeekbar();
                        if (seekbar && video) {
                            const progress = time / (1e3 * video.duration), x = null !== (_a = this._getMousePositionFromProgress(progress)) && void 0 !== _a ? _a : 0;
            ...
            _getVideoId() {
                var _a;
                return null !== (_a = Disney.getVideoId(new URL(window.location.href))) && void 0 !== _a ? _a : "";
            }
            _getVideoTitle() {
                var _a;
                const titleField = document.querySelector(".title-field");
        ...
        var PopupMessageType, ChatApiMessageType, DisneyVideoEventListener_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class DisneyVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi, pageControls) {
                var _a, _b;
                super(videoApi), this._onUpdate = this._onVideoUpdate.bind(this), this._onReplace = this.replaceStateInteraction.bind(this), 
                ...
                })), (null === (_a = window.teleparty) || void 0 === _a ? void 0 : _a.replaceScriptLoaded) || (debug("injecting replace script"), 
                function(script) {
            ...
            stopListening() {
                super.stopListening(), this._wrapperObserver.disconnect(), this._loadingObserver.disconnect();
                const video = this._videoApi.getVideoElement();
            ...
            loadNewVideoAsync(videoId) {
                return DisneyVideoEventListener_awaiter(this, void 0, void 0, (function*() {
        ...
        var _a, DisneyPageControls_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class DisneyPageControls extends class {
            ...
            shouldMenuBeVisible() {
                ...
                return 0 !== overlay.length && overlay.hasClass("overlay__controls--visually-show");
            }
            getControlsRoot() {
                return DisneyPageControls_awaiter(this, void 0, void 0, (function*() {
