...
(() => {
    ...
    (() => {
        "use strict";
        var browser = __webpack_require__(227), browser_default = __webpack_require__.n(browser);
        class Logger {
        ...
        var HboVideoType, StreamingServiceName;
        ...
        const ChromeStorageReadError = "Failed to read chrome storage. Please refresh the page and try again", VideoLoadError = "Failed to load video in time. Please refresh the page and try again.", GenericErrorMessage = "An unexpected error occured. Please refresh the page and try again.";
        ...
        var ReactionTypes, ContentScript_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class HuluContentScript extends class {
            ...
            constructor(huluChatApi, huluVideoApi, huluVideoEventListener, huluPageControls) {
                super(huluChatApi, huluVideoApi, huluVideoEventListener, huluPageControls), this.logger = new Logger("ext:ContentScripts:Hulu:HuluContentScript"), 
                this.logger.debug({
                    methodName: "constructor",
                    message: "Hulu Content Script"
                });
            }
        }
        ...
        var HuluChatApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class HuluChatApi extends class {
            ...
            constructor(videoApi) {
                super(), this.logger = new Logger("ext:ContentScripts:Hulu:HuluChatApi"), this.shouldShowReaction = () => !this._videoApi.currentlyWatchingAds, 
                this._injectChat = () => {
                    this._chatHtml && jQuery("#web-player-app").prepend(function(chatHtml, customCss = "") {
                        return `\n    <style>\n      ${css_alert}\n    </style>\n\n      <style tpInjected>\n    \n\n      .with-chat {\n        left: 0px !important;\n        width: calc(100% - 304px) !important;\n      }\n\n      .tp-video {\n        transition: width 250ms linear 0.2s;\n      }\n\n      ${customCss}\n    \n      ${chat}\n      \n    </style>\n\n    ${chatHtml}\n  `;
                    }(this._chatHtml, this._customCss));
                }, this.getVideoTitle = () => HuluChatApi_awaiter(this, void 0, void 0, (function*() {
                    return document.querySelector(".PlayerMetadata__title").innerText;
                })), this.fixFullScreen = () => HuluChatApi_awaiter(this, void 0, void 0, (function*() {
                    null != document.fullscreenElement ? this.onFullScreenChatVisible() : this.onExitFullScreen();
                })), this.onVideoChange = () => {
                    this.logger.debug({
                        methodName: "onVideoChange",
                        message: "On video change called."
                    }), this.getChatVisible() && !this.isPartyWindowsActive() && this.fixFullScreen();
                }, this.shouldAddReactionSpace = () => null !== document.fullscreenElement, this.getChatVisible = () => jQuery("#dash-player-container").hasClass("with-chat"), 
                this.removeChat = () => {
                    ...
                    jQuery(".ContentPlayer").addClass("with-chat"), jQuery("#dash-player-container").addClass("with-chat-fs");
                    const widthDecrease = (window.innerWidth - 304) / window.innerWidth, video = document.querySelector("#content-video-player");
                    (null == video ? void 0 : video.classList.contains("ContentPlayer__item--stretched")) && (this.shouldChatBeVisible() ? (void 0 === video._oldTransform && (video._oldTransform = video.style.transform), 
                    video.style.transform = `translate(-50%,-50%) scaleY(${widthDecrease})`) : video._oldTransform && (video.style.transform = video._oldTransform));
                }, this.onExitFullScreen = () => {
                    jQuery(".ViewModeControlBar").removeClass("huluFullScreenControls"), jQuery(".ControlsContainer__panel").removeClass("with-chat"), 
                    jQuery(".ContentPlayer").removeClass("with-chat"), jQuery("#dash-player-container").removeClass("with-chat-fs");
                    const video = document.querySelector("#content-video-player");
                    (null == video ? void 0 : video.classList.contains("ContentPlayer__item--stretched")) && (void 0 !== video._oldTransform ? video.style.transform = video._oldTransform : console.log("No transform"));
                }, this.onWrapperMouseDown = e => {
                    this._oldPageX = e.pageX, this._oldPageY = e.pageY;
                }, this.onWrapperMouseClick = e => {
                    ...
                    e.stopPropagation();
                }, this._oldPageX = 0, this._oldPageY = 0, this._customCss = "\n            .fix-ad-width {\n            min-width: fit-content;\n            }\n            \n            .AdUnitView__adBar__timer {\n            min-width: fit-content;\n            }\n            \n            .huluFullScreenControls {\n            right: calc(304px + 38px) !important;\n            }\n\n            .with-chat-fs .ContentPlayer {\n                left: 0px !important;\n                width: calc(100% - 304px) !important;\n            }\n        ", 
            ...
            setChatVisible(visible, userInitiated = !0) {
                ...
                return HuluChatApi_awaiter(this, void 0, void 0, (function*() {
                    try {
                    ...
                    jQuery("#dash-player-container").removeClass("with-chat"), jQuery("#dash-player-container").removeClass("with-chat-fs")), 
                    null != document.fullscreenElement && (jQuery("#dash-player-container").addClass("with-chat-fs"), 
                    visible ? this.onFullScreenChatVisible() : this.onExitFullScreen());
                }));
            }
        }
        ...
        var HuluPageControls_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class HuluPageControls extends class {
            ...
            constructor() {
                super(...arguments), this.getControlsRoot = () => HuluPageControls_awaiter(this, void 0, void 0, (function*() {
                    return jQuery("#web-player-app");
                }));
            }
            shouldMenuBeVisible() {
                const topControls = jQuery(".ViewModeControlBar").parent();
                return topControls.length > 0 && topControls.is(":visible") && "0" != topControls[0].style.opacity;
            }
        }
        var VideoType, VideoApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        var HuluVideoApi_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class HuluVideoApi extends class {
            ...
            constructor() {
                super(), this.logger = new Logger("ext:ContentScripts:Hulu:HuluVideoApi"), this.isWatchingAds = () => this._currentlyWatchingAds, 
                this.waitNewVideoReadyAsync = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    yield delayUntil((() => null != this._getCurrentTime() && this._getPlaybackState() !== PlaybackState.LOADING && this._getPlaybackState() !== PlaybackState.AD_PLAYING), 1 / 0)();
                })), this.waitVideoApiReadyAsync = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    var _a;
                    if (!this._video) try {
                        yield delayUntil((() => document.querySelector("#content-video-player") instanceof Element), 8e3)(), 
                        this._video = null !== (_a = document.querySelector("#content-video-player")) && void 0 !== _a ? _a : void 0;
                    } catch (error) {
                        throw this.logError(VideoLoadError, error), new Error(VideoLoadError);
                    }
                })), this.forceAd = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this._uiEventsHappening += 1;
                    try {
                        this.logger.debug({
                            methodName: "forceAd",
                            message: "Trying to force ad"
                        }), yield this.waitUpdateState(), this._state.paused && (this.logger.debug({
                            methodName: "forceAd",
                            message: "Triggering play"
                        }), yield this.play()), this._currentlyWatchingAds ? this.logger.debug({
                            methodName: "forceAd",
                            message: "In an ad"
                        }) : (yield delayUntil((() => this._currentlyWatchingAds || !this.checkForceAd()), 3e3)(), 
                        this._currentlyWatchingAds ? this.logger.debug({
                            methodName: "forceAd",
                            message: "Forced an Ad to Play :)"
                        }) : this.logger.debug({
                            methodName: "forceAd",
                            message: "Ad should be playing by now."
                        }));
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
                    ...
                    if (videoDuration && currentPosition) {
                        document.querySelectorAll(".TimelineAdBreaks__adbreak").forEach((val => {
                    ...
                    return !1;
                }, this.waitVideoDoneLoadingAsync = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    yield delayUntil((() => this._getPlaybackState() == PlaybackState.PLAYING || this._getPlaybackState() == PlaybackState.PAUSED), 1e4)();
                })), this.getStateAsync = () => new Promise(((resolve, reject) => {
                ...
                })), this.getVideoDataAsync = () => new Promise(((resolve, reject) => {
                    var _a, _b;
                    const videoType = this.videoType(), videoTitle = null !== (_a = this._getVideoTitle()) && void 0 !== _a ? _a : "", videoDuration = this._getDuration(), videoId = null !== (_b = this._getVideoId()) && void 0 !== _b ? _b : "", screen = this.getScreenSize(), episodeData = this._getEpisodeData(), content = this.getVideoContent(videoId, videoTitle, window.location.href, videoType, episodeData), state = this._getPlaybackState();
                    null !== videoTitle && null !== videoDuration && null !== videoId ? resolve({
                        ...
                        screen,
                        content,
                        videoState: null != state ? state : PlaybackState.NOT_READY
                    }) : reject();
                })), this.jumpToNextEpisode = nextEpisodeMessageData => new Promise((resolve => {
                    var _a;
                    this._uiEventsHappening += 1;
                    if ((null !== (_a = window.location.href.match(/^.*\/([a-z\-0-9]+)\??.*/)) && void 0 !== _a ? _a : [])[1] != nextEpisodeMessageData.videoId) {
                        const nextEpisodeId = nextEpisodeMessageData.videoId;
                        window.postMessage({
                            type: "nextEpisode",
                            nextEpisodeId
                        }, "*");
                ...
                })), this.pause = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    ...
                    try {
                        yield delayUntil((() => this._getPlaybackState() === PlaybackState.PAUSED), 1e3)();
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
                })), this.play = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    ...
                    try {
                        yield delayUntil((() => this._getPlaybackState() === PlaybackState.PLAYING), 2500)();
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
                })), this.freeze = milliseconds => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this._uiEventsHappening += 1;
                    try {
                ...
                })), this.setCurrentTime = time => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    this.logger.debug({
                        methodName: "setCurrentTime",
                        message: "Seek called with window post Message"
                    }), this._uiEventsHappening += 1, window.postMessage({
                        type: "SEEK",
                        time
                    }, "*");
                    try {
                        yield delay(250)(), yield delayUntil((() => this._getPlaybackState() !== PlaybackState.LOADING), 1e4);
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
                })), this.getVideoElement = () => document.querySelector("#content-video-player"), 
                this.videoType = () => {
                    const isEpisode = document.querySelector(".PlayerMetadata.OnNowMetadata > .PlayerMetadata__hitRegion > .PlayerMetadata__subTitle > .PlayerMetadata__seasonEpisodeText");
                    let result = "";
                    return document.querySelector(".PlayerMetadata--live") && (result = "live-"), result += isEpisode ? VideoType.episode : VideoType.movie, 
                    result;
                }, this._getEpisodeData = () => {
                    var _a, _b, _c, _d, _e;
                    let episodeData = {};
                    const metadata = document.querySelector(".PlayerMetadata.OnNowMetadata > .PlayerMetadata__hitRegion > .PlayerMetadata__subTitle"), title = null !== (_b = null === (_a = null == metadata ? void 0 : metadata.querySelector(".PlayerMetadata__subTitleText")) || void 0 === _a ? void 0 : _a.textContent) && void 0 !== _b ? _b : void 0, seasonEpisodeText = null === (_c = null == metadata ? void 0 : metadata.querySelector(".PlayerMetadata__seasonEpisodeText")) || void 0 === _c ? void 0 : _c.textContent;
                    if (seasonEpisodeText) {
                        const match_season = null !== (_d = null == seasonEpisodeText ? void 0 : seasonEpisodeText.match(/S(\d*)/)) && void 0 !== _d ? _d : [ "" ], match_episode = null !== (_e = null == seasonEpisodeText ? void 0 : seasonEpisodeText.match(/E(\d*)/)) && void 0 !== _e ? _e : [ "" ];
                        episodeData = {
                    ...
                    return episodeData;
                }, this._getAdVideoElement = () => document.querySelector("#ad-video-player"), this._getPlaybackState = () => {
                    const video = this.getVideoElement();
                    if (null === video || 0 === video.readyState) return PlaybackState.NOT_READY;
                    const loadingScreenContainerJqueryResult = jQuery(".loading-screen-container");
                    if (1 === video.readyState || loadingScreenContainerJqueryResult.length > 0 && "none" !== loadingScreenContainerJqueryResult[0].style.display) return PlaybackState.LOADING;
                    ...
                    const target = document.querySelector(".PlayerMetadata__title");
                    return target ? target.innerText : null;
                }, this._getVideoId = () => {
                    var _a;
                    return (null !== (_a = window.location.href.match(/^.*\/([a-z\-0-9]+)\??.*/)) && void 0 !== _a ? _a : [])[1];
                }, this.onNode = evt => {
                    const detail = evt.detail;
                    "UpdateState" === detail.type && (this._state = {
                        paused: detail.paused,
                        currentTime: detail.currentTime,
                        updatedAt: detail.updatedAt
                    });
                }, this.getStreamingServiceName = () => StreamingServiceName.HULU, this.waitUpdateState = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    var _b, _c;
                    ...
                    try {
                        yield delayUntil((() => this._state.updatedAt >= currentTime), 500, 10)();
                    } catch (error) {
                        const video = this.getVideoElement();
                        this._state = {
                            paused: null === (_b = null == video ? void 0 : video.paused) || void 0 === _b || _b,
                            currentTime: null !== (_c = this._getCurrentTime()) && void 0 !== _c ? _c : 0,
                            updatedAt: Date.now()
                        };
                    }
                })), this.getUpdateSessionDataAsync = () => HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    yield this.waitUpdateState();
                    return {
                        state: this._state.paused ? SessionState.PAUSED : SessionState.PLAYING,
                        lastKnownTime: this._state.currentTime,
                        lastKnownTimeUpdatedAt: this._state.updatedAt
                    };
                })), this._uiEventsHappening = 0, this._currentlyWatchingAds = !1, this._state = {
                    paused: !1,
                    updatedAt: 0,
                    currentTime: 0
                };
            ...
            doAdCheck() {
                ...
                return HuluVideoApi_awaiter(this, void 0, void 0, (function*() {
                    _super.doAdCheck.call(this), this.logger.debug({
                        methodName: "doAdCheck",
                        message: "Checking for ads"
                    }), this._currentlyWatchingAds ? this.logger.debug({
                        methodName: "doAdCheck",
                        message: "Already watching an ad"
                    }) : this.checkForceAd() ? (this.logger.debug({
                        methodName: "doAdCheck",
                        message: "Should force an ad"
                    }), yield this.forceAd()) : this.logger.debug({
                        methodName: "doAdCheck",
                        message: "Shouldn't force ad"
                    });
                }));
            }
        ...
        var HuluVideoEventListener_awaiter = function(thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))((function(resolve, reject) {
                function fulfilled(value) {
                    try {
                        step(generator.next(value));
        ...
        class HuluVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                var _a, _b;
                super(videoApi), this.logger = new Logger("ext:ContentScripts:Hulu:HuluVideoEventListener"), 
                this.getLoadingContainer = () => document.querySelector(".loading-screen-container"), 
                this.reloadListeners = () => {
                    this.logger.debug({
                        methodName: "reloadListeners",
                        message: "stopping listeners"
                    }), this.stopListening(), this.logger.debug({
                        methodName: "reloadListeners",
                        message: "starting listeners"
                    }), this.startListening(), this.logger.debug({
                        methodName: "reloadListeners",
                        message: "initialize listeners"
                    }), this.initListeners();
                }, this.initListeners = () => {
                    window.addEventListener("FromNode", this._onNodeMessage, !1);
                }, this.startListening = () => {
                    super.startListening(), this.logger.debug({
                        methodName: "startListening",
                        message: "disconnecting listeners"
                    ...
                    dynamicAdWrapper && (this.logger.debug({
                        methodName: "startListening",
                        message: "creating ad wrapper listener"
                    }), this._adObserver.observe(dynamicAdWrapper, {
                        childList: !0,
                        subtree: !1
                    }));
                    const videoWrapper = document.querySelector("#content-video-player");
                    videoWrapper && (this.logger.debug({
                        methodName: "startListening",
                        message: "creating video wrapper listener"
                    }), this._videoObserver.observe(videoWrapper, {
                        attributes: !0
                    }));
                    const loadingContainer = this.getLoadingContainer();
                    loadingContainer && (this.logger.debug({
                        methodName: "startListening",
                        message: "creating loading container listener"
                    }), this._loadingObserver.observe(loadingContainer, {
                        attributes: !0
                    ...
                    video && (this.logger.debug({
                        methodName: "startListening",
                        message: "adding video event listeners"
                    }), video.addEventListener("play", this._onUpdateBind), video.addEventListener("pause", this._onUpdateBind), 
                    video.addEventListener("seeking", this._onUpdateBind)), this.addVideoPlayerCloseButtonEventListener(), 
                    this._checkAdStart();
                }, this.stopListening = () => {
                    super.stopListening(), this.logger.debug({
                    ...
                    video && (this.logger.debug({
                        methodName: "stopListening",
                        message: "removing video event listeners"
                    }), video.removeEventListener("play", this._onUpdateBind), video.removeEventListener("pause", this._onUpdateBind), 
                    video.removeEventListener("seeking", this._onUpdateBind)), this.removeVideoPlayerCloseButtonEventListener();
                    const chatWrapper = jQuery("#chat-wrapper");
                ...
                }, this._onUpdateBind = this._onUpdate.bind(this), this._getVideo = () => document.querySelector("video"), 
                this.addVideoPlayerCloseButtonEventListener = () => {
                    const videoPlayerCloseButton = document.querySelector("div.ViewModeControlBar__button.CloseButton");
                    videoPlayerCloseButton ? videoPlayerCloseButton.addEventListener("click", this.videoPlayerCloseButtonOnClickEventHandler) : this.logger.debug({
                        methodName: "addVideoPlayerCloseButtonEventListener",
                        message: "unable to locate video player close button"
                    });
                }, this.removeVideoPlayerCloseButtonEventListener = () => {
                    const videoPlayerCloseButton = document.querySelector("div.ViewModeControlBar__button.CloseButton");
                    videoPlayerCloseButton ? videoPlayerCloseButton.removeEventListener("click", this.videoPlayerCloseButtonOnClickEventHandler) : this.logger.debug({
                        methodName: "removeVideoPlayerCloseButtonEventListener",
                        message: "unable to locate video player close button"
                    });
                }, this.videoPlayerCloseButtonOnClickEventHandler = event => {
                    this.logger.debug({
                        methodName: "videoPlayerCloseButtonOnClickEventHandler",
                        object: event
                    }), this._onTeardown(DEFAULT_TEARDOWN);
                }, this.loadNewVideoAsync = videoId => HuluVideoEventListener_awaiter(this, void 0, void 0, (function*() {
                    ...
                    yield new Promise(((resolve, reject) => {
                        const interval = setInterval((() => {
                            if (Services_Hulu.getVideoId(new URL(window.location.href)) === videoId) {
                                ...
                                if (null != videoElement && videoElement instanceof Element) return this.logger.debug({
                                    methodName: "loadNewVideoAsync",
                                    object: videoElement
                    ...
                    })), yield this._videoApi.waitNewVideoReadyAsync();
                })), this._checkAdStart = () => HuluVideoEventListener_awaiter(this, void 0, void 0, (function*() {
                    (yield this._videoApi.getStateAsync()).playbackState === PlaybackState.AD_PLAYING && (this.logger.debug({
                        methodName: "_checkAdStart",
                        message: "active ad class node added"
                    }), this.logger.debug({
                        methodName: "_checkAdStart",
                        message: "PEOPLE ARE WATCHING ADS"
                    }), this._onAdStart(), this._videoApi.currentlyWatchingAds = !0, this._observeAdTimer());
                })), this.shouldSync = () => !this._videoApi.currentlyWatchingAds, this._observeAdTimer = () => {
                    delayUntil((() => null != document.querySelector(".AdUnitView__adBar__timer")), 1e3)().then((() => {
                        this.logger.debug({
                            methodName: "_observeAdTimer",
                            message: "trying to observe new ad Timer"
                        });
                        const dynamicAdTimerWrapper = document.querySelector(".AdUnitView__adBar__timer");
                        dynamicAdTimerWrapper && (this.logger.debug({
                            methodName: "_observeAdTimer",
                            message: "observing new ad Timer"
                        }), this._adTimerObserver.disconnect(), this._adTimerObserver.observe(dynamicAdTimerWrapper, {
                            characterData: !0,
                ...
                }, this._checkIsMiniPlayerActive = () => !!document.querySelector(".Player__container--modal"), 
                this._checkAdFinished = () => {
                    delayUntil((() => !document.querySelector(".AdUnitView")), 2500)().then((() => {
                        var _a;
                        this.logger.debug({
                            methodName: "_checkAdFinished",
                            message: "PEOPLE STOPPED WATCHING ADS"
                        }), this._videoApi.currentlyWatchingAds = !1, this._onAdEnd(), null === (_a = this._videoMessageForwarder) || void 0 === _a || _a.forceSync();
                    }));
                }, this.replaceStateInteraction = event => {
                    var _a;
                    if (event.source != window) return;
                    const event_type = event.data.type;
                    if ("FROM_PAGE_POP" === event_type) {
                        if (this._checkIsMiniPlayerActive()) return;
                        this._onTeardown(DEFAULT_TEARDOWN);
                    } else if ("FROM_PAGE" === event_type) {
                        if (window.location.href.match(/^.*(entity=watch&id=).*/)) return void this.logger.debug({
                            methodName: "replaceStateInteraction",
                            message: "transition page detected"
                        });
                        if (window.location.href.match(/^.*\/(watch)\/.*/)) {
                            if (this.logger.debug({
                                methodName: "replaceStateInteraction",
                                message: "episode page detected"
                            }), null === (_a = this._videoMessageForwarder) || void 0 === _a ? void 0 : _a.changingVideo) return;
                            this._checkIsMiniPlayerActive() || this._chatApi.shouldChatBeVisible() && this._chatApi.setChatVisible(!0);
                            const nextVideoId = Services_Hulu.getVideoId(new URL(window.location.href));
                            if (!nextVideoId) return this.logger.debug({
                                methodName: "replaceStateInteraction",
                                message: "No video found. Tearing down"
                            }), void this._onTeardown(DEFAULT_TEARDOWN);
                            this._onNextEpisode(nextVideoId);
                        } else {
                            if (this.logger.debug({
                                methodName: "replaceStateInteraction",
                                message: "non-episode page detected"
                            }), this._checkIsMiniPlayerActive()) return void this._chatApi.setChatVisible(!1, !1).then((() => {
                                this._chatApi.fixPageControls();
                            }));
                            this._onTeardown(DEFAULT_TEARDOWN);
                        }
                ...
                this._onNodeMessage = this._videoApi.onNode.bind(this._videoApi), this._loadingObserver = new MutationObserver((mutationRecords => {
                    ...
                    for (const mutation of mutationRecords) if ("childList" === mutation.type) {
                        this.logger.debug({
                            methodName: "constructor",
                            message: "A child node has been added or removed."
                        });
                        ...
                        for (let i = 0; i < mutation.removedNodes.length; i++) {
                            ...
                            htmlNode.className && htmlNode.className.includes("AdUnitView") && this._checkAdFinished();
                        }
                    }
                ...
                this._adTimerObserver = new MutationObserver((() => {
                    var _a, _b;
                    document.querySelector(".AdUnitView__adBar__timer") && !(null === (_a = document.querySelector(".AdUnitView__adBar__timer")) || void 0 === _a ? void 0 : _a.className.includes("fix-ad-width")) && (null === (_b = document.querySelector(".AdUnitView__adBar__timer")) || void 0 === _b || _b.classList.add("fix-ad-width"), 
                    this.logger.debug({
                        methodName: "constructor",
                        message: "trying to fix width of ad timer"
                    }));
                })), (null === (_a = window.teleparty) || void 0 === _a ? void 0 : _a.replaceScriptLoaded) || (this.logger.debug({
                    methodName: "constructor",
                    message: "injecting replace script"
                }), function(script) {
        ...
        const logger = new Logger("ext:ContentScripts:Hulu:HuluContent");
        if (!window.teleparty || !(null === (_a = window.teleparty) || void 0 === _a ? void 0 : _a.contentScriptInjected)) {
            window.teleparty || (window.teleparty = {}), window.teleparty.contentScriptInjected = !0;
            const huluVideoApi = new HuluVideoApi, huluChatApi = new HuluChatApi(huluVideoApi), videoEventListener = new HuluVideoEventListener(huluVideoApi, huluChatApi);
            let pageControls;
            ...
            new HuluContentScript(huluChatApi, huluVideoApi, videoEventListener, pageControls), 
            logger.debug({
