...
curve = EllipticCurve(
    ...
    # Base point.
    g=(0x0fac9dfcbac8313bb2139f1bb755fef65bc391f8b36f8f8eb7371fd558b,
       0x1006a08a41903350678e58528bebf8a0beff867a7ca36716f7e01f81052),
    # Subgroup order.
    n=0x6901746346790563787434755862277025555839812737345013555379383634485463,
    # Subgroup cofactor.
    h=1,
)
...
alice_private_key, alice_public_key = make_keypair(3)
